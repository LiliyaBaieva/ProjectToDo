...
//    List<Task> toDoList = Parser.parser();
  ...
  public static void taskChange() throws IOException {
    ...
    System.out.println("Введите номер редактируемого задания от 1 до  -  " +  toDoList.size());
    int indexChangeTask = Integer.parseInt(br.readLine());
    System.out.println("Вы хотите изменить запись - " + toDoList.get(indexChangeTask - 1));
